...
from Scripts.SceneManager import SceneManager, MainMenu, CharacterSelection, BattleField, HiScores
...
game = SceneManager(state = data)           #This is the scene manager that keeps all the objects
...
while True:                                 #Literally, Gaem Loop
    ...
    game.Update()                           #Updating every GameObject that gets instanciated in scene
    display.update()